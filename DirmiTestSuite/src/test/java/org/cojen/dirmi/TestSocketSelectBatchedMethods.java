 ...
 */
public class TestSocketSelectBatchedMethods extends TestSocketBatchedMethods {
    public static void main(String[] args) {
        org.junit.runner.JUnitCore.main(TestSocketSelectBatchedMethods.class.getName());
    }
