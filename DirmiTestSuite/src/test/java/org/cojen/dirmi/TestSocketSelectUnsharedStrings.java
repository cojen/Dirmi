 ...
 */
public class TestSocketSelectUnsharedStrings extends TestSocketUnsharedStrings {
    public static void main(String[] args) {
        org.junit.runner.JUnitCore.main(TestSocketSelectUnsharedStrings.class.getName());
    }
